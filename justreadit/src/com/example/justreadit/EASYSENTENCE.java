...
public class EASYSENTENCE extends Fragment implements OnClickListener,OnItemClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		wordEditText.setHint("Add EASY sentence");
	...
	//	 ((LinearLayout)rootView1.getParent()).removeView(rootView1);
		...
		values = db.getContent(Constants.EASY_SENTENCES_TABLE);
	...
	public void onClick(View v) {
		...
		if(a.length>1)
		{
		    db.insertContent(wordEditText.getText().toString(),Constants.EASY_SENTENCES_TABLE);
		 ...
		 alert.setItems(a, new DialogInterface.OnClickListener() {
			 public void onClick(DialogInterface dialog, int item) {
			    	  ...
			    	  alert1.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
			              public void onClick(DialogInterface dialog, int id) {
			            	...
			            	//  String value = user.getText().toString();
			          		...
			          		if(a.length>1)
			          		{
			          			db.updateContent(data.getText().toString(),selectedFromList,Constants.EASY_SENTENCES_TABLE);
			          		    //db.insertContent(wordEditText.getText().toString(),Constants.EASY_SENTENCES_TABLE);
			   ...
			   AlertDialog builder1 = alert1.create();
			      ...
			      if(item==1)
			    	  {
			    	  db.delete(selectedFromList, Constants.EASY_SENTENCES_TABLE);
			    	  values = db.getContent(Constants.EASY_SENTENCES_TABLE);
			    	  ArrayAdapter<String> files = new ArrayAdapter<String>(getActivity(), 
		                      android.R.layout.simple_list_item_1, 
		                      values);
