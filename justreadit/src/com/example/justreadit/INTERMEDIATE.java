...
public class INTERMEDIATE extends Fragment implements OnClickListener,OnItemClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		wordEditText.setHint("Add INTERMEDIATE word");
	...
	//	 ((LinearLayout)rootView1.getParent()).removeView(rootView1);
		...
		values = db.getContent(Constants.INTERMEDIATE_WORDS_TABLE);
	...
	{		
		...
		Toast.makeText(getActivity(), "Enter a single word" ,Toast.LENGTH_SHORT).show();
		else
		{
		    db.insertContent(a[0],Constants.INTERMEDIATE_WORDS_TABLE);
		 ...
		 alert.setItems(a, new DialogInterface.OnClickListener() {
			 public void onClick(DialogInterface dialog, int item) {
			    	  ...
			    	  alert1.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
			              public void onClick(DialogInterface dialog, int id) {
			            	...
			            	//  String value = user.getText().toString();
			          		...
			          		{
			          		    db.updateContent(a[0],selectedFromList,Constants.INTERMEDIATE_WORDS_TABLE);
			   ...
			   AlertDialog builder1 = alert1.create();
			      ...
			      if(item==1)
			    	  {
			    	  db.delete(selectedFromList, Constants.INTERMEDIATE_WORDS_TABLE);
			    	  values = db.getContent(Constants.INTERMEDIATE_WORDS_TABLE);
			    	  ArrayAdapter<String> files = new ArrayAdapter<String>(getActivity(), 
		                      android.R.layout.simple_list_item_1, 
		                      values);
